<section class="bg-gray-100 min-h-screen flex justify-center " style="background-image: url('/static/assets/bg.png'); background-size: contain;" >
	<article class="prose-base lg:prose-xl max-w-7xl mx-auto p-4 text-justify text-gray-900">
		...
		<p class="text-justify">
			...
			our <strong>Artificial Intelligence and Deep Learning engine</strong>, which is trained on humongous data sets,
			making our solutions incredibly robust andsmart. All our products and solutions are integrated
			yet <strong>modular, ONVIF compliant, OS and hardware agnostic, scalable and interoperable.</strong>
		</p>
		<p class="text-justify">
			...
			Traffic Management System, Facial Recognition, <strong>
				Video Computing Platform as a Service (VCPaaS™)
		...
		<p class="text-justify">
			...
			viz.,<strong>Product Engineering Services, Aerospace & Defence and Homeland Security</strong>
		</p>
		<p class="text-justify">
			Mistral is an R&D centre recognized by the Department of Science and Technology, Govt. of
			India and <strong>certified by CEMILAC for design</strong>, testing and validation of defence electronics.
			Mistral is ISO/IEC 27001:2013 certified for its <strong>Information Security Management System</strong> (ISMS)
		...
		<p class="text-justify">
			GateBOT developed by Mialo is an <strong>ANPR (Automatic number plate recognition) solution</strong> which is
		...
		<p class="text-justify">
			...
			vehicle type, in/out time etc in the database.<strong>It can be seamlessly integrated with
				existing/new CCTV cameras, boom barriers, automatic gates, traffic lights, other audio video
				alert systems, and QR reader
			</strong> to deliver a complete unmanned experience. It performs real time
