...
>
	<article class="prose-base lg:prose-xl max-w-7xl mx-auto p-4 text-gray-900">
		...
		<img src="assets/photos/cctv 2.jpg" alt="" class="md:w-[50%] h-auto rounded-md mx-auto" />
		...
		<p>
			...
			point of both the customer and the industry. Unfortunately, the industry never realized its
			need. From the customer’s perspective, even the partners of the consortium do not gel and more
			often, the projects remain a patchy affair yielding no tangible results. The coming together
		...
		<ul class="list-decimal">
			...
			<li>
				...
				manage all the activities of the Center.
			</li>
			<li>
				To develop video command centre at RV College of Engineering at facilitate the centre for
				video analytics and related research
			</li>
			<li>
				To create guidelines for preparing standard Request for Proposal (RFP) and Standard
				Operating Procedures (SOPs), compliances and thus create standardized RFP and SOP.
			</li>
			<li>
				To explore the use of radios (point to point) in order to tremendously reduce the cost and
				time compared to wired networks.
			</li>
			<li>
				To provide skill development and create awareness to various stakeholders to maintain
				integrity in project development and deployment.
			</li>
			<li>
